...
export function Header() {
  ...
  return (
    <header
      // 💡 ここが魔法のクラス！
      // isScrolledがfalse(一番上)なら -translate-y-full(画面の上に隠す) + opacity-0(透明)
      // isScrolledがtrue(スクロールした)なら translate-y-0(定位置に戻す) + opacity-100(くっきり)
        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="shrink-0">
            <a href="#" className="flex items-center gap-3">
              ...
              <div>
                <div
                  className="text-base sm:text-xl tracking-tight font-medium"
